      ...
      <View style={[styles.card, isMobile && styles.cardMobile]}>
        ...
        <View style={[styles.leftSide, isMobile && { flex: 1, padding: 24, paddingVertical: 40 }]}>
          <View style={styles.formContainer}>
            ...
            <View style={styles.optionsRow}>
              ...
              >
                <Icon 
                  ...
                  size={20} 
                  color={rememberMe ? "#22C55E" : "#D1D5DB"} 
                />
            ...
            {/* Demo Login Link Added to match functionality */}
            ...
            >
              ...
              <View style={styles.imageContent}>
                ...
                <Text style={styles.quote}>
                  Grow smarter and manage your farm efficiently.
                </Text>
                <View style={styles.authorRow}>
                  <Image 
                    source={{ uri: 'https://api.dicebear.com/7.x/faces/svg?seed=Jackson' }} 
                    style={styles.avatar} 
                  />
                  <Text style={styles.authorName}>Jackson, SY</Text>
                </View>
              </View>
            </ImageBackground>
          </View>

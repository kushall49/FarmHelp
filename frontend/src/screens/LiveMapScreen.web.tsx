    ...
    <View style={styles.container}>
       <View style={styles.map}>
          <iframe 
            ...
            frameBorder="0" 
            style={{border: 0}}
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${location.coords.longitude-0.02},${location.coords.latitude-0.02},${location.coords.longitude+0.02},${location.coords.latitude+0.02}&layer=mapnik&marker=${location.coords.latitude},${location.coords.longitude}`}
          />
       </View>
